...
if __name__ == '__main__':
    ...
    parser.add_argument('--period_len', type=int, default=4, help='')
    ...
    parser.add_argument('--loss', type=str, default='MSE', help='loss function in [MSE, MAE, TimeLagLoss, FreDF, '
                                                                'TILDE-Q, TDTAlign, PS_Loss]')
    ...
    parser.add_argument('--query_independence', action='store_true', default=False,
                        help='sharing query across dimension')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.loss,
